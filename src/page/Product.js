...
import './Product.css'
import features from '../images/features_set-1 (1)(1).webp'
...
const product = () => {
  ...
  <div className="container py-5">
    ...
    <div className="row py-3">
      ...
      <div className="row py-3">
      <div className="col-lg-5 card-pink d-flex align-items-center justify-content-center">
        <img src="images/NipponPaint/kids_paint.webp" alt="paint" className="paint-img"/>
      </div>
      ...
      <div className="col-lg-7 card-dark d-flex flex-column justify-content-center text-white">
        ...
        <div className="row py-3">
      <div className="col-lg-5 card-pink d-flex align-items-center justify-content-center">
        <img src={features} className="paint-img"/>
      </div>
